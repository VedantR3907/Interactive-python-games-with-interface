...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        for i in range(1, 3):
            image = pygame.image.load(f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/Player/PlayerIdle{i}.png')
            image = pygame.transform.scale(image, (24, 24))
            self.idle_list.append(image)
        for i in range(1, 6):
            image = pygame.image.load(f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/Player/PlayerWalk{i}.png')
            right = pygame.transform.scale(image, (24, 24))
            left = pygame.transform.flip(right, True, False)
            self.walk_right.append(right)
            self.walk_left.append(left)
        for i in range(1, 5):
            image = pygame.image.load(f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/Player/PlayerAttack{i}.png')
            image = pygame.transform.scale(image, (24, 24))
            self.attack_list.append(image)
        for i in range(1, 11):
            image = pygame.image.load(f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/Player/PlayerDead{i}.png')
            image = pygame.transform.scale(image, (24, 24))
            self.death_list.append(image)
        for i in range(1, 3):
            image = pygame.image.load(f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/Player/PlayerHit{i}.png')
            image = pygame.transform.scale(image, (24, 24))
