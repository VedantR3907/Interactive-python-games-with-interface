...
BG1 = pygame.transform.scale(pygame.image.load("E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/BG1.png"), (WIDTH, HEIGHT))
BG2 = pygame.transform.scale(pygame.image.load('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/BG2.png'), (WIDTH, HEIGHT))
BG3 = pygame.transform.scale(pygame.image.load('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/BG3.png'), (WIDTH, HEIGHT))
MOON = pygame.transform.scale(pygame.image.load('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/BG1.png'), (300, 220))

# FONTS ***********************************************************************

title_font = "E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Fonts/Aladin-Regular.ttf"
instructions_font = "E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Fonts/BubblegumSans-Regular.ttf"
...
with open("E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Data/about.txt") as f:
    info = f.read().replace('\n', ' ')

# BUTTONS *********************************************************************

ButtonBG = pygame.image.load('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/ButtonBG.png')
...
pygame.mixer.music.load('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Sounds/mixkit-complex-desire-1093.mp3')
pygame.mixer.music.play(loops=-1)
pygame.mixer.music.set_volume(0.5)

diamond_fx = pygame.mixer.Sound('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Sounds/point.mp3')
diamond_fx.set_volume(0.6)
bullet_fx = pygame.mixer.Sound('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Sounds/bullet.wav')
jump_fx = pygame.mixer.Sound('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Sounds/jump.mp3')
health_fx = pygame.mixer.Sound('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Sounds/health.wav')
menu_click_fx = pygame.mixer.Sound('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Sounds/menu.mp3')
next_level_fx = pygame.mixer.Sound('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Sounds/level.mp3')
grenade_throw_fx = pygame.mixer.Sound('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Sounds/grenade throw.wav')
...
p_image = pygame.transform.scale(pygame.image.load('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/Player/PlayerIdle1.png'), (32, 32))
