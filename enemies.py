...
pygame.mixer.init()
bullet_fx = pygame.mixer.Sound('E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Sounds/ghost_shot.mp3')
...
class Ghost(pygame.sprite.Sprite):
    def __init__(self, x, y, win):
        ...
        for i in range(1, 6):
            image = pygame.image.load(f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/Ghost/Enemywalk{i}.png')
        ...
        for i in range(1, 3):
            image = pygame.image.load(f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/Ghost/Enemyhit{i}.png')
            image = pygame.transform.scale(image, (self.size, self.size))
            self.hit_list.append(image)
        for i in range(1, 9):
            image = pygame.image.load(f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Assets/Ghost/Enemydead{i}.png')
            image = pygame.transform.scale(image, (self.size, self.size))
