...
for index in range(1, NUM_TILES+1):
	img = pygame.image.load(f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Tiles/{index}.png')
	img_list.append(img)
...
def load_level(level):
	file = f'E:/Extra Codes/Python/Python Projects/Champion-zone-with-AI/Ghosterbuster_Pygame-2/Levels/level{level}_data'
